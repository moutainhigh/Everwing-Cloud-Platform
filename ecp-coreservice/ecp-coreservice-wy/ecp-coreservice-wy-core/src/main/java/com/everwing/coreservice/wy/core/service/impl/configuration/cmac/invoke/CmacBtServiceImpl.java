...
import com.everwing.coreservice.common.wy.service.configuration.cmac.service.CmacBtService;
...
@Service("cmacBtService")
public class CmacBtServiceImpl extends Resources implements CmacBtService {

	private static final Logger logger = LogManager.getLogger(CmacBtServiceImpl.class);
