package com.everwing.coreservice.wy.core.mq.billing.rebilling.wy;
...
@Service("wyRebillingListener")
public class WyReBillingListener extends ServiceRrcs implements MessageListener{
	
	private static final Logger logger = LogManager.getLogger(WyReBillingListener.class);
	...
	public void onMessage(Message message) {
		...
		if(CommonUtils.isNotEmpty(jsonStr)){
			...
			if(CommonUtils.isNotEmpty(e.getData())){
				...
				String feeStr = (e.getOpr() == 1) ? Constants.BILLING_WY : Constants.BILLING_BT;
				...
				this.wyBillingTaskService.rebilling(e.getCompanyId(),ids,e.getUserId(),e.getOpr());
