...
import com.everwing.coreservice.common.wy.service.configuration.cmac.single.servie.SingleCmacWyService;
...
@Service("singleCmacWyService")
public class SingleCmacWyServiceImpl extends Resources implements SingleCmacWyService {

	private static final Logger logger = LogManager.getLogger(SingleCmacWyServiceImpl.class);
