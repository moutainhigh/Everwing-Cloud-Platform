...
public class ProjectPrestoreAccount implements Serializable,Cloneable {
    private String id;

    private BigDecimal amount;

    private int prestoreType;
    ...
    public int getPrestoreType() {
        return prestoreType;
    }

    public void setPrestoreType(int prestoreType) {
    ...
    public String toString() {
        ...
        sb.append(", prestoreType=").append(prestoreType);
