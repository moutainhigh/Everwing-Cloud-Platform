 ...
 */
public interface TJfChargingSchemeService {
     ...
     * @return 执行结果
     */
    boolean insert(String companyId, TJfChargingScheme record);
     ...
     * @return 查询结果
     */
    TJfChargingScheme selectByPrimaryKey(String companyId, String id);
     ...
     * @return 查询集合信息
     */
    List<TJfChargingScheme> selectAll(String companyId);
     ...
     * @return 执行结果
     */
    boolean updateByPrimaryKey(String companyId, TJfChargingScheme record);
