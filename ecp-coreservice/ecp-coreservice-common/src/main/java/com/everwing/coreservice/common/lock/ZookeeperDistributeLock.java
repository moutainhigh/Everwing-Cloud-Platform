...
/**
 * Function:zookeeper分布式锁
 * Reason:
 * Date:2018/8/3
 *
 * @author wusongti@lii.com.cn
 */
public class ZookeeperDistributeLock extends AbstractDistributedLock {
    static Logger logger = LogManager.getLogger(ZookeeperDistributeLock.class);
    ...
    public static void main(String[] args) {
        ...
        try {
            zooKeeper = new ZooKeeper("127.0.0.1:2181", 60000, null);
        } catch (IOException e) {
            e.printStackTrace();
        }
