...
public class SimpleReport_Step05 {
	...
	private void build() {
		...
		try {
			report()//create new report design
			  ...
			  .title(cmp.text("统计报表").setStyle(boldCenteredStyle))//shows report title
	...
	private JRDataSource createDataSource() {
		...
		dataSource.add("现金收款", 1, new BigDecimal(500));
		dataSource.add("刷卡", 5, new BigDecimal(30));
		dataSource.add("刷卡", 1, new BigDecimal(28));
		dataSource.add("刷卡", 5, new BigDecimal(32));
		dataSource.add("支付宝", 3, new BigDecimal(11));
		dataSource.add("支付宝", 1, new BigDecimal(15));
		dataSource.add("微信", 5, new BigDecimal(10));
		dataSource.add("微信", 8, new BigDecimal(9));
		return dataSource;
	}
